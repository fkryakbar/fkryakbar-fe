            ...
            <div className="dark:text-white">
                ...
                <div className="lg:w-[70%] w-[90%] mx-auto mt-[50px]">
                    <h1 className="font-semibold">
                        ...
                        <p className="text-transparent text-gradient-primary lg:text-4xl text-3xl mt-1">Abdul Fikri Arhan</p>
                    </h1>
