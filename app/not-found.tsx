...
export default function notFound() {
    return (
        <>
            <div className="dark:text-white flex items-center justify-center h-screen lg:w-[10%] w-[50%] mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    ...
                    <g id="freepik--Planets--inject-15">
                        <g style={{ opacity: "0.30000000000000004" }}>
                            <path
                                ...
                                style={{ fill: "#F88989" }}
                            />
                            <circle cx="72.97" cy="216.13" r="1.32" style={{ fill: "#F88989" }} />
                            <circle cx="291.05" cy="408.33" r="1.89" style={{ fill: "#F88989" }} />
                            <circle cx="336.5" cy={332} r="1.32" style={{ fill: "#F88989" }} />
                            <path
                            ...
                            <path
                                ...
                                style={{ fill: "#F88989" }}
                            />
                            <circle cx="277.7" cy="136.94" r="1.32" style={{ fill: "#F88989" }} />
                        </g>
                        <circle cx="141.23" cy="116.36" r="21.91" style={{ fill: "#F88989" }} />
                        <circle
                            cx="141.23"
                            cy="116.36"
                            r="21.91"
                    ...
                    <g id="freepik--Astronaut--inject-15">
                        ...
                        <path
                            ...
                            style={{ fill: "#F88989", opacity: "0.30000000000000004" }}
                        />
                        <path
                        ...
                        <path
                            ...
                            style={{ fill: "#F88989", opacity: "0.6000000000000001" }}
                        />
                        <path
                    ...
                    <g id="freepik--Rocket--inject-15">
                        ...
                        <circle cx="222.2" cy="282.18" r="8.29" style={{ fill: "#F88989" }} />
                        <polygon
